            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    ...
                    <form action="login.php" method="POST">
                        <center><a class="error" style="color: red;"> <?php echo Login($rootpath.'index.php'); ?> </a></center>
                ...
                <!-- ############################################################################## -->
                        ...
                        <div class="register-link m-t-15 text-center">
                            <p> Vous n'avez pas de compte ? <a href=<?php echo $rootpath."Connexion/register.php"?>> Inscrivez-vous</a></p>
                        </div>
                        </div>
